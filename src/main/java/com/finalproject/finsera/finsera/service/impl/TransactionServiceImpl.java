...
public class TransactionServiceImpl implements TransactionService{
    ...
    public TransactionCheckAccountResponseDto check(TransactionCheckAccountRequestDto transactionCheckAccountRequestDto){
        ...
        TransactionCheckAccountResponseDto transactionCheckAccountResponseDto = new TransactionCheckAccountResponseDto();
        transactionCheckAccountResponseDto.setAccountnum_recipient(transactionCheckAccountRequestDto.getAccountnum_recipient());
        transactionCheckAccountResponseDto.setName_recipient(bankAccountsReceiver.getCustomer().getName());
        transactionCheckAccountResponseDto.setNominal(transactionCheckAccountResponseDto.getNominal());
        transactionCheckAccountResponseDto.setNote(transactionCheckAccountResponseDto.getNote());

        return transactionCheckAccountResponseDto;
    }
